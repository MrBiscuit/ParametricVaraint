...
import sty from './PlasmicTextInput.module.css'; // plasmic-import: y7q_0ypjEAV/css
        ...
        <div
            ...
            className={classNames(
                ...
                sty.root,
                {
                    ...
                    [sty.rootshowStartIcon]: hasVariant(variants, 'showStartIcon', 'showStartIcon'),
                }
            )}
            ...
            {(hasVariant(variants, 'showStartIcon', 'showStartIcon') ? true : true) ? (
                <div
                    ...
                    className={classNames(projectcss.all, sty.startIconContainer, {
                        ...
                        [sty.startIconContainercolor_dark]: hasVariant(variants, 'color', 'dark'),
                        [sty.startIconContainerisDisabled]: hasVariant(variants, 'isDisabled', 'isDisabled'),
                        [sty.startIconContainershowStartIcon]: hasVariant(variants, 'showStartIcon', 'showStartIcon'),
                    })}
                >
                    {p.renderPlasmicSlot({
                        defaultContents: (
                            <SearchsvgIcon className={classNames(projectcss.all, sty.svg__h1YCa)} role={'img'} />
                        ),

                        value: args.startIcon,
                        className: classNames(sty.slotTargetStartIcon, {
                            [sty.slotTargetStartIconcolor_dark]: hasVariant(variants, 'color', 'dark'),
            ...
            {(hasVariant(variants, 'showEndIcon', 'showEndIcon') ? true : true) ? (
                <div
                    ...
                    className={classNames(projectcss.all, sty.endIconContainer, {
                        [sty.endIconContainercolor_dark]: hasVariant(variants, 'color', 'dark'),
                        [sty.endIconContainershowEndIcon]: hasVariant(variants, 'showEndIcon', 'showEndIcon'),
                    })}
                >
                    {p.renderPlasmicSlot({
                        defaultContents: (
                            <ChecksvgIcon className={classNames(projectcss.all, sty.svg__u0HTo)} role={'img'} />
                        ),

                        value: args.endIcon,
                        className: classNames(sty.slotTargetEndIcon, {
                            [sty.slotTargetEndIconcolor_dark]: hasVariant(variants, 'color', 'dark'),
                            [sty.slotTargetEndIconshowEndIcon]: hasVariant(variants, 'showEndIcon', 'showEndIcon'),
                        }),
                    })}
                </div>
            ) : null}
